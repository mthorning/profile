...
function Resume(Props) {
  return React.createElement(Page$Profile.make, {
              children: null
                      ...
                      children: "Working on the frontend of a system which helps customers visualize their datacenter services through web pages and customisable dashboards. We have a number of micro-frontends written in React and vanilla JavaScript with some existing legacy code still using Backbone with Marionette."
                    }), React.createElement(Resume$Role, {
                      company: "Headforwards",
                      ...
                      children: "Targetting efficiency KPI's such as Items per Work Hour, I was responsible for increasing the efficiency of manual work areas by analysing and improving the ergonomics and processes within."

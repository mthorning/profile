...
function Resume$Table(Props) {
  ...
  return React.createElement("div", {
            ...
            }, React.createElement("h2", undefined, Utils$Profile.str(title)), React.createElement("div", {
...
function Resume(Props) {
  return React.createElement(Page$Profile.make, {
              title: "Resume",
              children: React.createElement(React.Fragment, undefined, React.createElement("section", undefined, React.createElement("p", undefined, Utils$Profile.str("I have been a JavaScript developer at Headforwards since October 2017. The client that my team works for is a large multinational telecommunications company. We build software which enables their customers to visualise and monitor their data center assets from customisable dashboards.")), React.createElement("p", undefined, Utils$Profile.str("Previous to this I was employed as a Work Area Manager at Royal Mail where I line-managed a team of around thirty people in addition to being responsible for maintaining the Quality of Service of the Mail Centre through a system of Continuous Improvement which has its roots in Lean Manufacturing."))), React.createElement("section", undefined, React.createElement(Resume$Table, {
                            headings: /* :: */[
                              "Employer",
                              /* :: */[
                                "Role",
                          ...
                          })), React.createElement("section", undefined, React.createElement("h2", undefined, Utils$Profile.str("Skills")), React.createElement("p", undefined, Utils$Profile.str("I have worked with several JavaScript frameworks. In my role at Headforwards I primarily use React but we also maintain legacy code which uses Backbone. Privately I have used Svelte, Vue and my other site is written using Gatsby. I have written back-ends for applications in Node as side projects, both using REST and GraphQl and have some experience of using Postgres, MongoDB and Redis.")), React.createElement("p", undefined, Utils$Profile.str("In addition to JavaScript I also have some experience of writing basic CLI applications in Rust and I built this website with ReasonML and ReasonReact.")), React.createElement("p", undefined, Utils$Profile.str("I'm confident with Linux operating systems, and have experience of continuous Integration tools such as Jenkins and Drone. I've worked with Docker and NGINX and I'm able to set up new domains and create SSL Certificates so that sites are served over HTTPS.")), React.createElement("p", undefined, Utils$Profile.str("I am able to quickly learn skills as I need them and most importantly work collaboratively with others to deliver on projects."))), React.createElement("section", undefined, React.createElement(Resume$Table, {
                            headings: /* :: */[
                              "Employer",
                              /* :: */[
                                "Role",

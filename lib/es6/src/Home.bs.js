...
function Home(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Banner$Profile.make, {
                  ...
                  className: "bg-p"
                      ...
                      className: "eight columns"
                    }, React.createElement("h5", undefined, Utils$Profile.str("I started writing blog posts about coding-related subjects which I find interesting, please take a look at my site hellocode.dev."))), React.createElement("div", {
                      className: "two columns",
                      style: pTop
                    }, React.createElement(Home$Button, {
                          text: "hellocode",

...
let make = _ => {
  <Page title="About Me">
    <h5>
      "I haven't always been a software developer, in case you're interested in how and why I changed careers, here's my story."
      ->str
    </h5>
    <hr />
    <p>

...
let workHistory = list{
  list{"Headforwards, Redruth", "JavaScript Developer", "October 2017", "Present"},
  list{"Royal Mail, Truro", "Work Area Manager", "February 2014", "October 2017"},
  list{"Royal Mail, Truro", "Deputy Manager", "May 2012", "February 2014"},
  list{"Royal Mail, Truro", "Postal Worker", "March 2003", "May 2012"},
  list{"City Music, Truro", "Sales Assistant", "February 2002", "March 2003"},
  list{"Penrose Outdoors, Truro", "Sales Assistant", "July 1999", "May 2001"},
}

let educationHistory = list{
  list{"Truro College", "BTEC National Diploma in Music Technology", "September 2004", "July 2006"},
  list{
    "Truro College",
  ...
  list{"Penair School, Truro", "GCSE's x 9", "September 1995", "July 2000"},
}

let tableBody = list =>
  list->mapElements(row =>
    <tbody> <tr> {row->mapElements(cell => <td key=cell> {cell->str} </td>)} </tr> </tbody>
  )
    ...
    <div style={css(~margin="3rem 0", ())}>
      <div style={css(~overflowX="auto", ())}>
        <table className="full-width">
          <thead>
            <tr> {headings->mapElements(heading => <th key=heading> {heading->str} </th>)} </tr>
          </thead>
          {tableBody(data)}
        </table>
      </div>
...
let make = () =>
  <Page>
    ...
    <section>
      ...
      <Table headings=list{"Employer", "Role", "From", "Until"} data=workHistory />
      <Role
        company="Headforwards" role="UI Developer - Insight project" period="Jan 2020 - present">
      ...
      <Role
        company="Headforwards" role="UI Developer - Nexcenter project" period="Oct 2017 - Jan 2020">
      ...
      <Role company="Royal Mail" role="Work Area Manager" period="Feb 2014 - Oct 2017">
      ...
      <Role company="Royal Mail" role="Quality Control Pillar Lead" period="Jun 2012 - Nov 2015">
      ...
      <Role
        company="Royal Mail" role="Workplace Organisation Pillar Lead" period="Nov 2015 - Oct 2017">
